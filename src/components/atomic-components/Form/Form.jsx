                ...
                <div className="contact-content custom-container">
                    ...
                    <div className="contact-form-section custom-container">
                        <div className="contact-form-content scroll-animate" data-anim="fade-in" data-delay="0.3s">
                            ...
                            {/* CONTACT INFO */}
                            <div className="contact-form-details mb-8 pb-4 flex 320:flex-col 991:flex-row justify-between">

                                <div className="contact-form-link p-4 flex gap-5 rounded-lg">
                                    <p><FontAwesomeIcon icon={faLocationDot} className="social-icons" /></p>
                                ...
                                <div className="contact-form-link p-4 flex gap-5 rounded-lg">
                                    <p><FontAwesomeIcon icon={faPhone} className="social-icons" /></p>
                                    <div className="contact-form-text flex flex-col gap-5">
                                ...
                                <div className="contact-form-link p-4 flex gap-5 rounded-lg">
                                    <p><FontAwesomeIcon icon={faEnvelope} className="social-icons" /></p>
                                    <div className="contact-form-text flex flex-col gap-5">
